          ...
          <div className="flex justify-center items-center py-20">
            ...
            >
              ...
              <path
                ...
                fill="currentColor"
                d="M4 12a8 8 0 018-8v4l3.5-3.5L12 0v4a8 8 0 018 8h-4l3.5 3.5L24 12h-4a8 8 0 01-8 8v-4l-3.5 3.5L12 24v-4a8 8 0 01-8-8h4L4.5 8.5 0 12h4z"
              />
            </svg>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <p className="text-sm text-gray-500 mb-1">
                    Created by: <strong>{userId?.username || "Unknown"}</strong>
                  </p>

                  <h3 className="text-indigo-900 font-semibold text-xl mb-2">
                    {title}
                  </h3>
                  <p className="text-indigo-700 mb-4 line-clamp-3">{content}</p>
